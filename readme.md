...
# Awesome JAX [![Awesome](https://awesome.re/badge.svg)](https://awesome.re)[<img src="https://raw.githubusercontent.com/google/jax/master/images/jax_logo_250px.png" alt="JAX Logo" align="right" height="100">](https://github.com/google/jax) ⭐ 34,867 | 🐛 2,464 | 🌐 Python | 📅 2026-02-15 with stars

<!--lint ignore double-link-->

[JAX](https://github.com/google/jax) ⭐ 34,867 | 🐛 2,464 | 🌐 Python | 📅 2026-02-15 brings automatic differentiation and the [XLA compiler](https://www.tensorflow.org/xla) together through a [NumPy](https://numpy.org/)-like API for high performance machine learning research on accelerators like GPUs and TPUs.
...
* [Videos](#videos)
* [Papers](#papers)<https://github.com/jax-ml/jax> ⭐ 34,867 | 🐛 2,464 | 🌐 Python | 📅 2026-02-15
...
* Neural Network Libraries
  * [HuggingFace Transformers](https://github.com/huggingface/transformers) ⭐ 156,513 | 🐛 2,267 | 🌐 Python | 📅 2026-02-16 - Ecosystem of pretrained Transformers for a wide range of natural language tasks (Flax). <img src="https://img.shields.io/github/stars/huggingface/transformers?style=social" align="center">
  ...
  * [Flax](https://github.com/google/flax) ⭐ 7,077 | 🐛 464 | 🌐 Jupyter Notebook | 📅 2026-02-14 - Centered on flexibility and clarity. <img src="https://img.shields.io/github/stars/google/flax?style=social" align="center">
  * [Flax NNX](https://github.com/google/flax/tree/main/flax/nnx) ⭐ 7,077 | 🐛 464 | 🌐 Jupyter Notebook | 📅 2026-02-14 - An evolution on Flax by the same team <img src="https://img.shields.io/github/stars/google/flax?style=social" align="center">
  ...
  * [Equinox](https://github.com/patrick-kidger/equinox) ⭐ 2,773 | 🐛 234 | 🌐 Python | 📅 2026-02-11 - Callable PyTrees and filtered JIT/grad transformations => neural networks in JAX. <img src="https://img.shields.io/github/stars/patrick-kidger/equinox?style=social" align="center">
...
* [NumPyro](https://github.com/pyro-ppl/numpyro) ⭐ 2,599 | 🐛 67 | 🌐 Python | 📅 2026-02-15 - Probabilistic programming based on the Pyro library. <img src="https://img.shields.io/github/stars/pyro-ppl/numpyro?style=social" align="center">
...
* [Optax](https://github.com/deepmind/optax) ⭐ 2,181 | 🐛 64 | 🌐 Python | 📅 2026-02-09 - Gradient processing and optimization library. <img src="https://img.shields.io/github/stars/deepmind/optax?style=social" align="center">
...
* [BRAX](https://github.com/google/brax) ⭐ 3,060 | 🐛 99 | 🌐 Jupyter Notebook | 📅 2026-02-12 - Differentiable physics engine to simulate environments along with learning algorithms to train agents for these environments. <img src="https://img.shields.io/github/stars/google/brax?style=social" align="center">
...
* [MaxText](https://github.com/google/maxtext) ⭐ 2,138 | 🐛 248 | 🌐 Python | 📅 2026-02-16 - A simple, performant and scalable Jax LLM written in pure Python/Jax and targeting Google Cloud TPUs. <img src="https://img.shields.io/github/stars/google/maxtext?style=social" align="center">
...
* [gymnax](https://github.com/RobertTLange/gymnax) ⭐ 858 | 🐛 39 | 🌐 Python | 📅 2025-05-30 - Reinforcement Learning Environments with the well-known gym API. <img src="https://img.shields.io/github/stars/RobertTLange/gymnax?style=social" align="center">
...
* [JAX Toolbox](https://github.com/NVIDIA/JAX-Toolbox) ⭐ 382 | 🐛 118 | 🌐 Python | 📅 2026-02-15 - Nightly CI and optimized examples for JAX on NVIDIA GPUs using libraries such as T5x, Paxml, and Transformer Engine. <img src="https://img.shields.io/github/stars/NVIDIA/JAX-Toolbox?style=social" align="center">
...
* [FDTDX](https://github.com/ymahlau/fdtdx) ⭐ 237 | 🐛 45 | 🌐 Python | 📅 2026-02-13 - Finite-Difference Time-Domain Electromagnetic Simulations in JAX <img src="https://img.shields.io/github/stars/ymahlau/fdtdx?style=social" align="center">
...
* [jaxns](https://github.com/Joshuaalbert/jaxns) ⭐ 221 | 🐛 15 | 🌐 Python | 📅 2026-02-15 - Nested sampling in JAX.
...
* [Vision Transformer](https://github.com/google-research/vision_transformer) ⭐ 12,296 | 🐛 139 | 🌐 Jupyter Notebook | 📅 2026-01-30 - Official implementation of [*An Image is Worth 16x16 Words: Transformers for Image Recognition at Scale*](https://arxiv.org/abs/2010.11929).
...
* [Adversarial Robustness](https://github.com/deepmind/deepmind-research/tree/master/adversarial_robustness) ⭐ 14,695 | 🐛 323 | 🌐 Jupyter Notebook | 📅 2026-02-10 - Reference code for [*Uncovering the Limits of Adversarial Training against Norm-Bounded Adversarial Examples*](https://arxiv.org/abs/2010.03593) and [*Fixing Data Augmentation to Improve Adversarial Robustness*](https://arxiv.org/abs/2103.01946).
* [Bootstrap Your Own Latent](https://github.com/deepmind/deepmind-research/tree/master/byol) ⭐ 14,695 | 🐛 323 | 🌐 Jupyter Notebook | 📅 2026-02-10 - Implementation for the paper [*Bootstrap your own latent: A new approach to self-supervised Learning*](https://arxiv.org/abs/2006.07733).
* [Gated Linear Networks](https://github.com/deepmind/deepmind-research/tree/master/gated_linear_networks) ⭐ 14,695 | 🐛 323 | 🌐 Jupyter Notebook | 📅 2026-02-10 - GLNs are a family of backpropagation-free neural networks.
* [Glassy Dynamics](https://github.com/deepmind/deepmind-research/tree/master/glassy_dynamics) ⭐ 14,695 | 🐛 323 | 🌐 Jupyter Notebook | 📅 2026-02-10 - Open source implementation of the paper [*Unveiling the predictive power of static structure in glassy systems*](https://www.nature.com/articles/s41567-020-0842-8).
* [MMV](https://github.com/deepmind/deepmind-research/tree/master/mmv) ⭐ 14,695 | 🐛 323 | 🌐 Jupyter Notebook | 📅 2026-02-10 - Code for the models in [*Self-Supervised MultiModal Versatile Networks*](https://arxiv.org/abs/2006.16228).
* [Normalizer-Free Networks](https://github.com/deepmind/deepmind-research/tree/master/nfnets) ⭐ 14,695 | 🐛 323 | 🌐 Jupyter Notebook | 📅 2026-02-10 - Official Haiku implementation of [*NFNets*](https://arxiv.org/abs/2102.06171).
* [OGB-LSC](https://github.com/deepmind/deepmind-research/tree/master/ogb_lsc) ⭐ 14,695 | 🐛 323 | 🌐 Jupyter Notebook | 📅 2026-02-10 - This repository contains DeepMind's entry to the [PCQM4M-LSC](https://ogb.stanford.edu/kddcup2021/pcqm4m/) (quantum chemistry) and [MAG240M-LSC](https://ogb.stanford.edu/kddcup2021/mag240m/) (academic graph)
  tracks of the [OGB Large-Scale Challenge](https://ogb.stanford.edu/kddcup2021/) (OGB-LSC).
* [WikiGraphs](https://github.com/deepmind/deepmind-research/tree/master/wikigraphs) ⭐ 14,695 | 🐛 323 | 🌐 Jupyter Notebook | 📅 2026-02-10 - Baseline code to reproduce results in [*WikiGraphs: A Wikipedia Text - Knowledge Graph Paired Datase*](https://aclanthology.org/2021.textgraphs-1.7).
* [AlphaFold](https://github.com/deepmind/alphafold) ⭐ 14,258 | 🐛 299 | 🌐 Python | 📅 2026-01-15 - Implementation of the inference pipeline of AlphaFold v2.0, presented in [*Highly accurate protein structure prediction with AlphaFold*](https://www.nature.com/articles/s41586-021-03819-2).
...
* [JAX, Flax & Transformers 🤗](https://github.com/huggingface/transformers/blob/9160d81c98854df44b1d543ce5d65a6aa28444a2/examples/research_projects/jax-projects/README.md#talks) ⭐ 156,513 | 🐛 2,267 | 🌐 Python | 📅 2026-02-16 - 3 days of talks around JAX / Flax, Transformers, large-scale language modeling and other great topics.
...
* [JAX GitHub Discussions](https://github.com/google/jax/discussions) ⭐ 34,867 | 🐛 2,464 | 🌐 Python | 📅 2026-02-15
